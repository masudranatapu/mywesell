...
class ProductController extends Controller
{
    ...
    {
        if(Auth::user()->total_post < 1) {
            flash('Your post limit is orver. Please upgrade your package.')->success();
    ...
    public function store(ProductRequest $request)
    {
        ...
        $totalPostExist = Auth::user()->total_post - 1;

        User::findOrFail($id)->update([
            'total_post' => $totalPostExist,
        ]);
