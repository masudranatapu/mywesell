...
use App\Http\Controllers\MySellerPackageController;
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    // My Seller Package
    Route::resource('my-seller-package', MySellerPackageController::class);
    Route::controller(MySellerPackageController::class)->group(function () {
        Route::get('/my-seller-package/edit/{id}', 'edit')->name('my-seller-package.edit');
        Route::get('/my-seller-package/destroy/{id}', 'destroy')->name('my-seller-package.destroy');
    });
