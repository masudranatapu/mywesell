                ...
                @canany(['view_all_orders', 'view_inhouse_orders','view_seller_orders','view_pickup_point_orders'])
                    <li class="aiz-side-nav-item">
                        <a href="#" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text">{{translate('Order Manage')}}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <!--Submenu-->
                        <ul class="aiz-side-nav-list level-2">
                ...
                @canany(['header_setup','footer_setup','view_all_website_pages','website_appearance'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            <li class="aiz-side-nav-item">
                                <a href="{{route('sliders.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['sliders.index', 'sliders.create', 'sliders.edit'])}}" >
