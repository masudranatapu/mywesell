...
<head>
    ...
    <link rel="stylesheet" href="{{ static_asset('new-assets/css/plugin.css') }}">
    <link rel="stylesheet" href="{{ static_asset('new-assets/css/style.css') }}">
    <link rel="stylesheet" href="{{ static_asset('new-assets/css/aiz-core.css') }}">
    <link rel="stylesheet" href="{{ static_asset('new-assets/css/responsive.css') }}">
...
<body>
    ...
    @include('frontend.inc.additional')
    
    @include('frontend.inc.login-modal')
    @include('frontend.inc.register-modal')
    ...
    <div class="modal fade" id="addToCart">
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                ...
                <button type="button" class="close absolute-top-right btn-icon close z-1" data-dismiss="modal" aria-label="Close" onclick="cloaseAddToCartModal()">
    ...
    <script src="{{ static_asset('new-assets/js/plugin.js') }}"></script>
    <script src="{{ static_asset('new-assets/js/script.js') }}"></script>
    ...
    <script>
        ...
        function openLoginForm(){
            $('#user_register_modal').modal('hide');
        ...
        function cloaseAddToCartModal(){$('#addToCart').modal('hide');}
        ...
        function addToCart(){
            ...
            if(checkAddToCartValidity()) {
                ...
                AIZ.plugins.notify('success', "{{ translate('Successfuly added to cart.') }}");
            }
            else{
