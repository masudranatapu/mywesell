<div class="modal login-register-modal fade" id="login_register" data-bs-keyboard="false" tabindex="-1" aria-labelledby="login_registerLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="login-register-wrapper">
                    <div class="d-flex align-items-center justify-content-between gap-2 mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <button type="button" class="btn btn-toggle btn-sm btn-outline-primary" onclick="openRegisterForm()">to register</button>
                        </div>
                    </div>
