<div class="modal-body p-4 added-to-cart">
    ...
    <!--                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';" width="60"-->
    <!--                            >-->
    <!--                        </a>-->
    <!--                    </div>-->
    ...
    <div class="text-center">
        <button class="btn btn-outline-primary mb-3 mb-sm-0" data-dismiss="modal" onclick="cloaseAddToCartModal()">{{ translate('Back to shopping')}}</button>
