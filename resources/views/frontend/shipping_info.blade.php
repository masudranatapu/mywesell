...
<div class="bg-dark py-2 text-center">
    <h6 class="mb-0 text-white">Shipping Information</h6>
</div>
<section class="mb-4 gry-bg">
    <div class="container">
        <div class="row cols-xs-space cols-sm-space cols-md-space">
            <div class="col-xxl-8 col-xl-10 mx-auto checkout-card mt-3">
                <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_shipping_infostore') }}" role="form" method="POST">
                    ...
                    <div class="row align-items-center mb-3">
                        <div class="col-md-6 text-center text-md-left order-1 order-md-0">
                            <a href="{{ route('home') }}" class="add-cart-btn">
                                {{ translate('Return to shop')}}
                            </a>
                        </div>
                        <div class="col-md-6 text-center text-md-right">
                            <button type="submit" class="add-cart-btn">{{ translate('Continue to Payment Info')}}</a>
                        </div>
                    </div>
                </form>
            </div>
