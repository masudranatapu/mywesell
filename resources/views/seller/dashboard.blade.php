...
@section('panel_content')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">{{ __('Current Package') }}</span>
                            </p>
                            <h5 class="text-white">
                                {{ $packageName->name ?? '' }}
                            </h5>
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">{{ __('Total Post Limit') }}</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                {{ Auth::user()->total_post }}
                            </h3>
                        </div>
                        <div class="col-auto text-right">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <p class="small text-muted mb-0">
                                <span class="fe fe-arrow-down fe-12"></span>
                                <span class="fs-14 text-light">Total Storage</span>
                            </p>
                            <h3 class="mb-0 text-white fs-30">
                                {{ Auth::user()->total_storage ?? 0 }} MB
                            </h3>
                        </div>
                        <div class="col-auto text-right">
                            <svg xmlns="http://www.w3.org/2000/svg" width="64.001" height="64" viewBox="0 0 64.001 64">
        ...
        @if(Auth::user()->package_validate < now())
            <div class="col-sm-6 col-md-6 col-xxl-3">
                <a href="{{ route('seller.pack') }}">
                    <div class="card shadow-none mb-4 bg-warning py-4">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col">
                                    <p class="small text-muted mb-0">
                                        <span class="fe fe-arrow-down fe-12"></span>
                                        <span class="fs-14 text-light">{{ __('Upgrade Your Plan') }}</span>
                                    </p>
                                    <h5 class="text-white">
                                        {{ __('Upgrade Now') }}
                                    </h5>
            ...
            <div class="card shadow-none bg-soft-primary mb-0">
                ...
                @php
                    ...
                    $orderTotal = \App\Models\Order::where('seller_id', Auth::user()->id)
                        ...
                        ->sum('grand_total');
                @endphp
                @if(Auth::user()->available_days_validate < now())
                    <div class="card-body">
                        <div class="card-title text-primary fs-16 fw-600">
    ...
    <div class="row">
        @if(Auth::user()->withdraw_days_validate < now())
